...
(function(s,l,d,t){
    ...
    a.transitions={
        ...
        zoomOut:function(){
            var b=a.wrap,c=a.current,d=c.openEffect,f="elastic"===d,g={
                opacity:0
            };
        ...
        changeIn:function(){
            var b=a.wrap,c=a.current,d=c.nextEffect,f="elastic"===d,g=a._getPosition(f),i={
                opacity:1
            };
        ...
        changeOut:function(){
            var b=a.wrap,c=a.current,e=c.prevEffect,f={
                opacity:0
            };
